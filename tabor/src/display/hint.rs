...
use tabor_terminal::grid::{BidirectionalIterator, Dimensions};
use tabor_terminal::index::{Boundary, Column, Direction, Line, Point};
use tabor_terminal::term::cell::Hyperlink;
use tabor_terminal::term::search::{Match, RegexIter, RegexSearch};
...
mod tests {
    ...
    use tabor_terminal::vte::ansi::Handler;
